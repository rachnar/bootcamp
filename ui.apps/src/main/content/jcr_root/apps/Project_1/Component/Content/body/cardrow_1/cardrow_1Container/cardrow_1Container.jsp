...
<%}%>
 ...
 <div class="${set}">
      ...
      <cq:include path="${slide2}" resourceType="/apps/Project_1/Component/Content/body/cardrow_1/cardrow_1Slide"/>
      </c:forEach>
 </div>
 </div>
 </div>

<div class="col" style="height:${height}"><cq:include path="customImage" resourceType="/apps/Project_1/Component/Content/body/customImage"/>
    </div>

...
<cq:include path="imgbg" resourceType="/apps/Project_1/Component/Content/body/imgBgComponent"/>
<cq:include path="imginfra" resourceType="/apps/Project_1/Component/Content/body/infraComponent"/>
...
<cq:include path="connect_component" resourceType="foundation/components/parsys"/>
    ...
    <cq:include path="news&updates" resourceType="/apps/Project_1/Component/Content/body/newsandupdates"/></div>
